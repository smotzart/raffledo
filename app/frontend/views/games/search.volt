      ...
      <div class="box-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="d-none d-xl-block col-12 col-md-3">
            ...
            <div>
              {% if (game.type_register == 1) %}<i class="fas mr-2 fa-sign-in-alt"></i>{% endif %}              
              {% if (game.type_sms == 1) %}<i class="fas mr-2 fa-comment-alt text-warning"></i>{% endif %}
              {% if (game.type_buy == 1) %}<i class="fas mr-2 fa-phone text-warning"></i>{% endif %}
              {% if (game.type_internet == 1) %}<i class="fas mr-2 fa-shopping-basket"></i>{% endif %}
              {% if (game.type_submission == 1) %}<i class="fas mr-2 fa-gamepad"></i>{% endif %}
            </div>
          </div>
